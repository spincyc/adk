...
pencil plate helps with physical orientation only.
...
\subsection{A transfer without display flicker}
...
step, so intermediate shifted bytes are not shown.
...
Startup begins at zero without a bright transient & \checkbox & \\
