...
Sketch commit & \blank{1.3in} & Sketch path & \blank{1.4in}\\[7pt]
Firmware artifact/hash & \blank{1.1in} & Source tree state & \blank{1.15in}\\[7pt]
CLI version & \blank{1.35in} & AVR core version & \blank{1.2in}\\[7pt]
Board & Mega 2560 revision: \blank{1.0in} & USB cable & \blank{1.05in}\\[7pt]
USB supply/model & \blank{1.3in} & Supply current limit & \blank{1.05in}\\[7pt]
74HC595 marking & \blank{1.4in} & Display marking & \blank{1.15in}\\[7pt]
Display polarity & \blank{1.2in} & Resistors & \blank{1.15in}\\[7pt]
Unloaded 5 V & \blank{1.2in} & Loaded 5 V, glyph 8 & \blank{1.05in}\\[7pt]
USB current, glyph 8 & \blank{1.05in} & Display-current total & \blank{1.15in}\\
\end{tabularx}

\subsection{Glyph-8 resistor and current worksheet}

\begin{center}
\begin{tabular}{c*{8}{c}}
\toprule
Path & a/Q0 & b/Q1 & c/Q2 & d/Q3 & e/Q4 & f/Q5 & g/Q6 & dp/Q7\\
\midrule
\(R\), \(\Omega\) & \blank{0.25in} & \blank{0.25in} & \blank{0.25in} &
  \blank{0.25in} & \blank{0.25in} & \blank{0.25in} &
  \blank{0.25in} & \blank{0.25in}\\
\(V_R\), V & \blank{0.25in} & \blank{0.25in} & \blank{0.25in} &
  \blank{0.25in} & \blank{0.25in} & \blank{0.25in} &
  \blank{0.25in} & dark\\
\(I=V_R/R\), mA & \blank{0.25in} & \blank{0.25in} & \blank{0.25in} &
  \blank{0.25in} & \blank{0.25in} & \blank{0.25in} &
  \blank{0.25in} & 0\\
\bottomrule
\end{tabular}
\end{center}
Glyph 8 lights a--g and leaves dp dark. Sum the seven calculated currents and
compare that value with the 40\,mA display limit; separately record total USB
current, which also includes the board and register. Attach a signed worksheet
if the available instrument log provides these same eight path fields.
...
D13 gives a 250 ms acquisition pulse and 750 ms separator & \checkbox & \\
Digits 0--9 are stable and correctly mapped & \checkbox & \\
Analyzer record names channels, sample rate, trigger, and decoded TP-DATA byte & \checkbox & \\
TP-CLOCK shows eight pulses before one TP-LATCH edge & \checkbox & \\
All eight resistor values/drops/currents and glyph-8 total are recorded & \checkbox & \\
Loaded/unloaded rail and glyph-8 total USB current meet limits & \checkbox & \\
...
Each unpowered-installed midpoint fixture passes after 120 s shutdown & \checkbox & \\
