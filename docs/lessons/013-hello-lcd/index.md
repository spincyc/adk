...
- **Backlight.** Behind the glass is an LED, with its own pins **A** (+) and
  **K** (−), and like every LED since [Lesson 1](../001-blink/index.md) it gets
...
Open the Arduino IDE and choose **File → Examples → Adk → lessons → 013-hello-lcd**:
...
Now upload the sketch as in [Lesson 1](../001-blink/index.md#upload-it), and
