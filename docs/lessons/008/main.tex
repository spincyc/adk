...
midpoint fixture\\
Evidence & TP-A0 voltage, raw and transformed trace, D6 duty/brightness,
...
run. Confirm a new 250\,ms acquisition pulse and repeat the response from an
identical knob position. The automated suite also runs a deterministic
D6-conflict artifact.
...
TP-A0 moves, D6 fixed & inspect expected mapped/average/deadband trace;
...
stage-by-stage diagnosis. Physical acceptance remains in the controlled
campaign; this lesson remains host-verified.
