...
\begin{circuitikz}[american voltages]
  \draw (0,4) node[left]{Mega 5 V} to[short,o-] (1,4)
    to[potentiometer,l={10 k\(\Omega\) linear},name=P] (1,1)
    -- (1,0.5) node[ground]{};
  \draw (P.wiper) -- (4.5,2.5) node[above]{TP-A0}
    -- (6,2.5) node[right]{Mega A0 / pin 54};
  \draw (0,0) node[left]{Mega D6 PWM} to[short,o-,l^={TP-D6}] (1.2,0)
    to[R,l={\(\geq220\,\Omega\)}] (3.7,0)
    to[leD,l={external LED}] (6,0) -- (6,-0.5) node[ground]{};
\end{circuitikz}
\end{center}
...
\begin{center}
% ADK visual: pencil
\includegraphics[width=\linewidth,height=0.22\textheight,keepaspectratio]
  {008-evidence-chain-pencil.png}
\end{center}
