...
[Lesson 4](../004-mood-lamp/index.md)'s moods, always holds the same number
...
[Lesson 5](../005-melody-maker/index.md) grouped a button and a pitch. So
...
!!! warning "Unplug first"
    ...
    as in [Lesson 5](../005-melody-maker/index.md): never leave it out.
...
Open **File → Examples → Adk → lessons → 006-simon**:
