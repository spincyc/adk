...
\textbf{Joystick} & \textbf{Mega 2560 + console} & \textbf{Presentation}\\
TP-X: field & supplied-time update & LCD: field/values\\
TP-Y: coarse preview & commit/cancel policy & RGB: console state\\[4pt]
\textbf{Encoder} & & four LEDs: preview nibble\\
TP-A + TP-B: trim & & optional piezo: acknowledgement\\
button: cancel & & \\
\end{tabular}
\end{minipage}}
...
\[
\boxed{\text{TP-X/TP-Y/TP-A/TP-B}}\rightarrow
\boxed{\text{component snapshots}}\rightarrow
\boxed{\text{console snapshot}}\rightarrow
\boxed{\text{LCD/RGB/LEDs}}.
\]
