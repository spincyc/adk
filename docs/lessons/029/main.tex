...
\section{Current and resource bound}
...
\begin{enumerate}
  \item Hold Review and observe the steady blue Review state.
  \item While Review remains held, press Run and observe the first cue enter
        Confirmation with the fast red cadence.
  \item While that confirmation is still open, press Confirm and observe only
        cue LED index 0 with the steady green state.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Leave the buttons untouched and observe immediate darkness and
        released indicator endpoints at the fixed two-minute ending; then
        remove USB power.
\end{enumerate}
...
Deterministic host tests, strict headers and style, Mega compilation, measured
size, monochrome PDF, and site packaging establish the software boundary.
They do not establish a physical result. Bench acceptance remains open until
the repository's controlled acceptance campaign records the exact board,
parts, instruments, predictions, observations, interpretations, and shutdown
evidence.
...
uses 10,952 bytes of flash and 1,832 bytes of static RAM on the Mega 2560.
