...
\begin{tikzpicture}[x=1cm,y=1cm,>=Latex,
    ...
    \draw[very thick,wireR,solid,->] (p6)--(rr)--(red);
    \draw[very thick,wireG,dashed,->] (p5)--(rg)--(green);
    \draw[very thick,wireB,densely dotted,->] (p3)--(rb)--(blue);
...
\begin{tikzpicture}[>=Latex,node distance=10mm,
    ...
    \draw[->,wireR,thick,solid] (rgb)--(r);
    \draw[->,wireG,thick,dashed] (rgb)--(g);
    \draw[->,wireB,thick,densely dotted] (rgb)--(b);
\end{tikzpicture}
\end{center}
