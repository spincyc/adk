...
{019-range-state-pencil.png}

\small\textit{Pencil state map: Idle starts Awaiting Echo. An Echo rise starts
Measuring; its fall produces Valid. Awaiting Echo can instead produce Timeout,
and Measuring can instead produce Out of range.}
\end{center}
