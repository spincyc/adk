...
[Lesson 14](../014-thermometers/index.md), the screen from
[Lesson 13](../013-hello-lcd/index.md), the RGB LED from Lesson 4 and a knob
...
Open **File → Examples → Adk → lessons → 015-weather-station**:
