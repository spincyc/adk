...
[Lesson 3](../003-reaction-duel/index.md) had its own switching circuit inside,
...
??? info "The signal's path through the buzzer"
    ...
    The four buttons are wired just as in [Lesson 2](../002-buttons/index.md):
...
Open **File → Examples → Adk → lessons → 005-melody-maker**:
