...
These targets verify code and publication. They do not establish physical
verification. There is intentionally no transmit, replay, clone, brute-force,
scan, or protocol-export target.
