...
Evidence & focused host traces & Status & E0 core implemented; publication unsupported\\
...
into each timestamped frame. That core and its focused host tests are
implemented. The endpoint-owning Mega adapter, exact specimen, electrical
schematic, board example, and physical evidence remain future gated work.
...
replay. Adapter acquisition, transactional rollback, endpoint sample order,
Mega size, and physical evidence remain future work because the adapter has
not been introduced.
