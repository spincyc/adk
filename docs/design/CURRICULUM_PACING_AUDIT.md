...
| 049 | Component | **Historical proposal, superseded:** RFID card observation with an owned RC522. **Current:** fixed local identity records and bounded enrollment over copied evidence. | The historical RFID scope is retained here as audit evidence, not as implementation direction. The current E0 lesson treats identifiers as local tokens rather than authentication; powered RFID remains a later qualified-input gate. See the current [cadence](../projects/component_project_cadence.md#lessons-049--051-identity-controlled-parts-carousel) and [work queue](../WORK_QUEUE.md). |
| 050 | Component | **Historical proposal, superseded:** authorization policy over supplied identifiers. **Current:** pure bounded homing and logical-position policy. | Copied home and stop evidence produces bounded logical step intent; physical position remains unknown until a separately recorded powered homing acceptance. See the current [cadence](../projects/component_project_cadence.md#050--positioning-and-homing) and [work queue](../WORK_QUEUE.md). |
| 051 | Project | **Historical proposal, superseded:** inert attendance/demo kiosk. **Current:** inert identity-controlled tabletop parts carousel. | Copied identity and confirmation evidence composes with bounded homing, travel, gate, presentation, and audit intent without claiming powered endpoints, physical motion, gate actuation, or persistent writes. See the current [cadence](../projects/component_project_cadence.md#051--project-tabletop-parts-carousel) and [work queue](../WORK_QUEUE.md). |
