...
- Lessons 001--060 are promoted and host verified; physical cards remain open.
...
The newest published lesson is Lesson 060. The post-deploy verifier follows
Lesson 060 and has a regression check that
