...
namespace {
    ...
    void observeOperator (adk::TimePoint now)
    {
        ...
        {
            observations[selectedChannel] = {selectedChannel,
                                             selectedPrimary,
                                             selectedRedundant,
                                             now};
        }
    ...
    bool patternActive (adk::InertChannelState state, uint32_t phase)
    {
        switch (state)
        {
            ...
            case adk::InertChannelState::Contradictory:
                return phase % 400 < 200;
